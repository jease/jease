...
import jease.cmf.web.servlet.JeaseSessionListener;
...
public class TableModel extends ObjectTableModel<User> {
	...
	public String[] getColumns() {
		return new String[] { I18N.get("Login"), I18N.get("Name"), I18N.get("Role"),
				I18N.get("Session"), I18N.get("Roots") };
	}

	public int[] getProportions() {
		return new int[] { 2, 3, 2, 2, 6 };
	}
	...
	public Object getValue(User user, int column) {
		...
		case 3:
			...
			return lastAccessedTime != 0 ? new Date(lastAccessedTime) : "";
		case 4:
