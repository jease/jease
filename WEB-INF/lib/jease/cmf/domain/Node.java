...
public class Node extends Persistent {
	...
	public void setId(String id) {
		String oldPath = null;
		if (Validations.isNotEmpty(getId())
				&& Validations.isNotEmpty(getParent())) {
			oldPath = getPath();
		}
		this.id = id;
		if (Validations.isNotEmpty(oldPath)) {
	...
	public void appendChild(Node child) {
		String oldPath = null;
		if (Validations.isNotEmpty(child.getId())
				&& Validations.isNotEmpty(child.getParent())) {
