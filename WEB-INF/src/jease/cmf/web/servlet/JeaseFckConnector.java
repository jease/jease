...
public class JeaseFckConnector extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Node[] roots = (Node[]) request.getSession().getAttribute(
				JeaseSession.JEASE_ROOTS);

		if (currentFolder.equals("/")
				&& !Arrays.contains(roots, Nodes.getRoot())) {
	...
	private void writeCurrentFolderXML(PrintWriter out, Node[] roots,
