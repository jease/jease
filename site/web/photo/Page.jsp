...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/site/web/photo/style/screen.css" media="screen" />
...
<body>
	<div id="header">	
		...
		<h1><a href="<%=request.getContextPath() %>/">jease.org</a></h1>		
		...
		<form id="search" action="<%=request.getContextPath() %>/" method="get">
